...
!define OLD_APP_NAME "ADIN1300 Evaluation"
...
!define INSTALLER_NAME "Analog Devices Ethernet PHY Installer_v1200.exe"
!define MAIN_APP_EXE "ADIN1300-Eval.exe"
!define INSTALL_TYPE "SetShellVarContext current"
!define REG_ROOT "HKCU"
!define REG_APP_PATH "Software\Microsoft\Windows\CurrentVersion\App Paths\${MAIN_APP_EXE}"
!define UNINSTALL_PATH "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}"
!define PRODUCT_NAME "ADIN1300"
...
InstallDir "C:\Analog Devices\ADIN1300"
...
SetOverwrite on
SetOutPath "$INSTDIR"
File "..\ADIN1300-Eval\bin\Release\ADIN1300-Eval.exe"
File "..\ADIN1300-Eval\bin\Release\DeviceCommunication.dll"
File "..\ADIN1300-Eval\bin\Release\FTD2XX_NET.dll"
File "readme.rtf"
File "${LICENSE_RTF}"
File "..\ADIN1300-Eval\bin\Release\registers_adin1100.json"
File "..\ADIN1300-Eval\bin\Release\registers_adin1300.json"
File "..\ADIN1300-Eval\bin\Release\registers_adin1301.json"
File "..\ADIN1300-Eval\bin\Release\registers_adin1200.json"
File "..\ADIN1300-Eval\bin\Release\registers_scripts.json"
File "..\ADIN1300-Eval\bin\Release\TargetInterface.dll"
...
File "..\ADIN1300-Eval\bin\Release\Utilities.dll"

SetOutPath "$INSTDIR\doc"
File "ADIN1300_Datasheet.pdf"
File "EVAL-ADIN1300FMCZ-UG-1635.pdf"
File "ADIN1200_Datasheet.pdf"
File "EVAL-ADIN1200FMCZ-UG-1673.pdf"
...
CreateDirectory "$SMPROGRAMS\Analog Devices\ADIN1300"
CreateShortCut "$SMPROGRAMS\Analog Devices\ADIN1300\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\${MAIN_APP_EXE}"
CreateShortCut "$SMPROGRAMS\Analog Devices\ADIN1300\Uninstall ${APP_NAME}.lnk" "$INSTDIR\uninstall.exe"

CreateShortCut "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1300 Datasheet.lnk" "$INSTDIR\doc\ADIN1300_Datasheet.pdf"
CreateShortCut "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1300 User Guide.lnk" "$INSTDIR\doc\EVAL-ADIN1300FMCZ-UG-1635.pdf"
CreateShortCut "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1200 Datasheet.lnk" "$INSTDIR\doc\ADIN1200_Datasheet.pdf"
CreateShortCut "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1200 User Guide.lnk" "$INSTDIR\doc\EVAL-ADIN1200FMCZ-UG-1673.pdf"
...
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\${OLD_APP_NAME}.lnk" 
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\Uninstall ${OLD_APP_NAME}.lnk"

# Delete the ADIN1200 files , and files from the older installations to avoid confusion
Delete "$INSTDIR\doc\UG-ADIN1300.pdf"
Delete "$INSTDIR\doc\UG-ADIN1200.pdf"
...
Section Uninstall
${INSTALL_TYPE}
Delete "$INSTDIR\ADIN1300-Eval.exe"
...
Delete "$INSTDIR\registers_adin1100.json"
Delete "$INSTDIR\registers_adin1300.json"
Delete "$INSTDIR\registers_adin1301.json"
Delete "$INSTDIR\registers_adin1200.json"
Delete "$INSTDIR\registers_scripts.json"
...
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\${APP_NAME}.lnk"
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1300 Datasheet.lnk" 
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1300 User Guide.lnk"
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1200 Datasheet.lnk" 
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\ADIN1200 User Guide.lnk"
Delete "$SMPROGRAMS\Analog Devices\ADIN1300\Uninstall ${APP_NAME}.lnk"

Delete "$DESKTOP\${APP_NAME}.lnk"

RmDir "$SMPROGRAMS\Analog Devices\ADIN1300"
!endif
