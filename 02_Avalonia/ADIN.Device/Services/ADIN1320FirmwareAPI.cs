// <copyright file="ADIN1320FirmwareAPI.cs" company="Analog Devices Inc.">
...
namespace ADIN.Device.Services
{
    public class ADIN1320FirmwareAPI : IADIN1320API
    {
        ...
        public ADIN1320FirmwareAPI(IFTDIServices ftdiService, ObservableCollection<RegisterModel> registers, int phyAddress, object mainLock)
        {
