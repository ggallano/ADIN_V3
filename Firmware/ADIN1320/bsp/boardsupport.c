...
mxc_gpio_cfg_t gpio_adin1320_linkSt;
mxc_gpio_cfg_t gpio_adin1320_phyInt;

mxc_gpio_cfg_t gpio_adin1300_linkSt;
mxc_gpio_cfg_t gpio_adin1300_phyInt;
...
uint32_t BSP_GpioInit(void)
{
    ...
    /* ADIN1320 Configuration */
    /* Configure the ADIN1320-LED0 Green	10BASE-T1L Link
                     ADIN1320-LED1 Yellow	10BASE-T1L Activity*/

    /* Configure ADIN1320 PHY Link Status - P0.18 */
    gpio_adin1320_linkSt.port = MXC_GPIO_PORT0;
    gpio_adin1320_linkSt.mask = MXC_GPIO_ADIN1320_LINKST;
    gpio_adin1320_linkSt.pad  = MXC_GPIO_PAD_NONE;
    gpio_adin1320_linkSt.func = MXC_GPIO_FUNC_IN;
    MXC_GPIO_Config(&gpio_adin1320_linkSt);

    /* Configure ADIN1320 PHY Interrupt - P0.19 */
    gpio_adin1320_phyInt.port = MXC_GPIO_PORT0;
    gpio_adin1320_phyInt.mask = MXC_GPIO_ADIN1320_PHYINT;
    gpio_adin1320_phyInt.pad  = MXC_GPIO_PAD_NONE;
    gpio_adin1320_phyInt.func = MXC_GPIO_FUNC_IN;
    MXC_GPIO_Config(&gpio_adin1320_phyInt);

    /* ADIN1300 Configuration */

    /* Configure ADIN1300 PHY Link Status - P0.20 */
    gpio_adin1300_linkSt.port = MXC_GPIO_PORT0;
    gpio_adin1300_linkSt.mask = MXC_GPIO_ADIN1300_LINKST;
    gpio_adin1300_linkSt.pad  = MXC_GPIO_PAD_NONE;
    gpio_adin1300_linkSt.func = MXC_GPIO_FUNC_IN;
    MXC_GPIO_Config(&gpio_adin1300_linkSt);

    /* Configure ADIN1300 PHY Interrupt - P0.21 */
    gpio_adin1300_phyInt.port = MXC_GPIO_PORT0;
    gpio_adin1300_phyInt.mask = MXC_GPIO_ADIN1300_PHYINT;
    gpio_adin1300_phyInt.pad  = MXC_GPIO_PAD_NONE;
    gpio_adin1300_phyInt.func = MXC_GPIO_FUNC_IN;
    MXC_GPIO_Config(&gpio_adin1300_phyInt);
