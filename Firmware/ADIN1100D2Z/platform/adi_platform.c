 ...
 *
 * @details        MDIO Indirect Read from Clause 45 register space via Clause 22
 *
 * @sa             adi_MdioWrite_Cl22()
 */
 ...
 * @return        none
 *
 * @details       MDIO Indirect Write to Clause 45 register space via Clause 22
 *
 * @sa            adi_MdioRead_Cl22()
 */
