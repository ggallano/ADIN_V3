...
/* ADIN1100: 10BASE-T1L Single Pair Ethernet PHY core */
...
#define ADDR_DIGIO_PINMUX2                              (0X1E8C57U)    /* Pinmux Configuration 2 Register */
...
#define ADDR_RMII_CFG                                   (0X1F8050U)    /* RMII Configuration Register */
...
#define RSTVAL_MMD1_DEV_ID2                               (0XBC81)
...
#define RSTVAL_DIGIO_PINMUX2                              (0XFF)
...
#define RSTVAL_MMD2_DEV_ID2                               (0XBC81)
...
/* ----------------------------------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------------------------------- */
#define BITP_CRSM_MAC_IF_CFG_CRSM_RGMII_EN           (0U)           /* RGMII MAC Interface Enable */
#define BITL_CRSM_MAC_IF_CFG_CRSM_RGMII_EN           (1U)           /* RGMII MAC Interface Enable */
#define BITM_CRSM_MAC_IF_CFG_CRSM_RGMII_EN           (0X0001U)      /* RGMII MAC Interface Enable */
#define BITP_CRSM_MAC_IF_CFG_CRSM_RMII_EN            (4U)           /* RMII MAC Interface Enable */
#define BITL_CRSM_MAC_IF_CFG_CRSM_RMII_EN            (1U)           /* RMII MAC Interface Enable */
#define BITM_CRSM_MAC_IF_CFG_CRSM_RMII_EN            (0X0010U)      /* RMII MAC Interface Enable */
...
#define BITP_CRSM_MAC_IF_CFG_CRSM_RMII_CLK_EN        (14U)          /* CRSM RMII Clock Enable Status */
#define BITL_CRSM_MAC_IF_CFG_CRSM_RMII_CLK_EN        (1U)           /* CRSM RMII Clock Enable Status */
#define BITM_CRSM_MAC_IF_CFG_CRSM_RMII_CLK_EN        (0X4000U)      /* CRSM RMII Clock Enable Status */
#define BITP_CRSM_MAC_IF_CFG_CRSM_RMII_CLK50         (15U)          /* This Bit Indicates If the RMII REF_CLK Frequency is 50 MHz or 25 MHz. Only for Debugging Purposes. */
#define BITL_CRSM_MAC_IF_CFG_CRSM_RMII_CLK50         (1U)           /* This Bit Indicates If the RMII REF_CLK Frequency is 50 MHz or 25 MHz. Only for Debugging Purposes. */
#define BITM_CRSM_MAC_IF_CFG_CRSM_RMII_CLK50         (0X8000U)      /* This Bit Indicates If the RMII REF_CLK Frequency is 50 MHz or 25 MHz. Only for Debugging Purposes. */
...
/* ----------------------------------------------------------------------------------------------------
          DIGIO_PINMUX2                                         Value             Description
   ---------------------------------------------------------------------------------------------------- */
#define BITP_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX        (0U)           /* Pin Mux Select for TX_SOP */
#define BITL_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX        (4U)           /* Pin Mux Select for TX_SOP */
#define BITM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX        (0X000FU)      /* Pin Mux Select for TX_SOP */
#define BITP_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX        (4U)           /* Pin Mux Select for RX_SOP */
#define BITL_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX        (4U)           /* Pin Mux Select for RX_SOP */
#define BITM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX        (0X00F0U)      /* Pin Mux Select for RX_SOP */

#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_RXD_3  (0X0000U)      /* RXD_3 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_RXD_2  (0X0001U)      /* RXD_2 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_RXD_1  (0X0002U)      /* RXD_1 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_RX_CLK (0X0003U)      /* RX_CLK */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_RX_DV  (0X0004U)      /* RX_DV */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_RX_ER  (0X0005U)      /* RX_ER */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_TX_ER  (0X0006U)      /* TX_ER */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_TX_EN  (0X0007U)      /* TX_EN */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_TX_CLK (0X0008U)      /* TX_CLK */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_TXD_1  (0X0009U)      /* TXD_1 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_TXD_2  (0X000AU)      /* TXD_2 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_TXD_3  (0X000BU)      /* TXD_3 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_LINK_ST (0X000CU)      /* LINK_ST */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_LED_0  (0X000DU)      /* LED_0 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_LED_1  (0X000EU)      /* LED_1 */
#define ENUM_DIGIO_PINMUX2_DIGIO_RXSOP_PINMUX_OFF    (0X000FU)      /* OFF */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_RXD_3  (0X0000U)      /* RXD_3 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_RXD_2  (0X0001U)      /* RXD_2 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_RXD_1  (0X0002U)      /* RXD_1 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_RX_CLK (0X0003U)      /* RX_CLK */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_RX_DV  (0X0004U)      /* RX_DV */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_RX_ER  (0X0005U)      /* RX_ER */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_TX_ER  (0X0006U)      /* TX_ER */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_TX_EN  (0X0007U)      /* TX_EN */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_TX_CLK (0X0008U)      /* TX_CLK */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_TXD_1  (0X0009U)      /* TXD_1 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_TXD_2  (0X000AU)      /* TXD_2 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_TXD_3  (0X000BU)      /* TXD_3 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_LINK_ST (0X000CU)      /* LINK_ST */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_LED_0  (0X000DU)      /* LED_0 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_LED_1  (0X000EU)      /* LED_1 */
#define ENUM_DIGIO_PINMUX2_DIGIO_TXSOP_PINMUX_OFF    (0X000FU)      /* OFF */
...
/* ----------------------------------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------------------------------- */
#define BITP_FG_IFG_LEN_FG_IFG_LEN                   (0U)           /* Frame Generator INTER-_FRAME Gap Length */
#define BITL_FG_IFG_LEN_FG_IFG_LEN                   (16U)          /* Frame Generator INTER-_FRAME Gap Length */
#define BITM_FG_IFG_LEN_FG_IFG_LEN                   (0XFFFFU)      /* Frame Generator INTER-_FRAME Gap Length */
