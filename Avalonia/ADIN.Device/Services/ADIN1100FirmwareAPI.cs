...
namespace ADIN.Device.Services
{
    public class ADIN1100FirmwareAPI : IADIN1100API
    {
        ...
        public ADIN1100FirmwareAPI(IFTDIServices ftdiService, int phyAddress, object mainLock)
        {
        ...
        public ADIN1100FirmwareAPI(IFTDIServices ftdiService, ObservableCollection<RegisterModel> registers, int phyAddress, object mainLock)
        {
            _ftdiService = ftdiService;
