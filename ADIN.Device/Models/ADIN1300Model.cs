...
namespace ADIN.Device.Models
{
    public class ADIN1300Model : AbstractADINFactory
    {
        ...
        private void GetInitialValuesLoopback()
        {
            ...
            Loopback.SelectedLoopback.RxSuppression = ((ADIN1300FirmwareAPI)FirmwareAPI).RegisterRead("IsolateRx") == "1" ? true : false;
            Loopback.SelectedLoopback.TxSuppression = ((ADIN1300FirmwareAPI)FirmwareAPI).RegisterRead("LbTxSup") == "1" ? true : false;
        }
